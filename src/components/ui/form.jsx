...
export default function AdmissionForm() {
  ...
  const [formData, setFormData] = useState( // Added last class studied field
  initialState);
  ...
  <form onSubmit={handleSubmit} className="space-y-6">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> {/* Responsive grid */}
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => setFormData({ ...formData, fatherInfo: e.target.value })}
          className="w-full"
          required
        />
      </div>
      ...
      {/* Guardian's Info */}
      <div className="space-y-2">
        <Label htmlFor="guardianInfo">Guardian's Name & Qualification (if any)</Label>
        <Input
          id="guardianInfo"
      ...
      {/* Annual Income */}
      <div className="space-y-2">
        <Label htmlFor="annualIncome">Annual Income of Parent/Guardian</Label>
        <Input
          id="annualIncome"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> {/* Responsive grid */}
      {/* Sibling Info */}
      <div className="space-y-2">
        <Label htmlFor="siblingInfo">Name of brother/sister studying in this school (if any)</Label>
        <Input
          id="siblingInfo"
          value={formData.siblingInfo}
          onChange={(e) => setFormData({ ...formData, siblingInfo: e.target.value })}
          className="w-full"
        />
      </div>
      ...
      {/* Handicapped */}
      <div className="space-y-2">
        <Label htmlFor="isHandicapped">Whether the Pupil is mentally or physically handicapped?</Label>
        <Select
          value={formData.isHandicapped}
          onValueChange={(value) => setFormData({ ...formData, isHandicapped: value })}
        >
      ...
      {/* Last School */}
      <div className="space-y-2">
        <Label htmlFor="lastSchool">Name and Address of last attended school</Label>
        <Input
          id="lastSchool"
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => setFormData({ ...formData, lastClassStudied: e.target.value })}
          className="w-full"
          required
        />
      </div>
